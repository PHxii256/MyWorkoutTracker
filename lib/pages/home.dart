  ...
  Widget build(BuildContext context) {
    ...
    return ScaffoldGradientBackground(
      gradient: const LinearGradient(
        ...
        colors: <Color>[Color.fromARGB(132, 9, 116, 116), Color.fromARGB(255, 0, 0, 0)],
        stops: <double>[0, 0.8],
      ),
      ...
      appBar: AppBar(
        ...
        title: Text(
          ...
          style: const TextStyle(
            color: Color.fromARGB(255, 14, 151, 138),
            fontSize: 50,
          ),
        ),
      ),
      ...
      child: Container(
        ...
        child: ElevatedButton(
          style: ButtonStyle(
            ...
            backgroundColor: const MaterialStatePropertyAll(Color.fromARGB(255, 12, 12, 12)),
            overlayColor: const MaterialStatePropertyAll(Color.fromARGB(255, 27, 27, 27)),
          ),
          onPressed: () {
          ...
          child: Expanded(
            child: Stack(
              ...
              children: <Widget>[
                Padding(padding: const EdgeInsets.only(bottom: 50), child: Icon(icon, size: 75)),
                Align(
